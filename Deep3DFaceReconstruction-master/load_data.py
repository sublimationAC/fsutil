...
def transferBFM09():
	...
	print('load data.py: shapePC shape',shapePC.shape,'shapeEV: ',shapeEV.shape,'shapeMU',shapeMU.shape,'texMU',texMU.shape)
	print('expPC',expPC.shape,'expEV',expEV.shape)
	...
	# print('index_exp',index_exp.shape,'max: min: ',index_exp.max(),index_exp.min())
	index_shape = loadmat('BFM/BFM_exp_idx.mat')
	index_shape = index_shape['trimIndex'].astype(np.int32) - 1 #starts from 0 (to 53490)
	# print('index_shape: ',index_shape.shape,'max min: ',index_shape.max(),index_shape.min())
	index_shape = index_shape[index_exp]
	# print('after index_shape: ',index_shape.shape,'max min: ',index_shape.max(),index_shape.min())
