...
def Compute_norm(face_shape,facemodel):
	...
	print('face_norm.shape: ',face_norm.shape)
	return v_norm
...
def Reconstruction(coeff,facemodel):
	...
	temp_3d=np.concatenate([face_projection,z_buffer], axis = 2)
	...
	return face_shape,face_texture,face_color,tri,temp_3d,z_buffer,landmarks_2d,lighting,face_norm_r
